...
import { listAlerts, listPlants, listSensors, getPlant, updateAlertStatus } from "../lib/Api";
    ...
    return (
        <section>
            ...
            <p className="alert-meta">
                ...
                <span className="badge alert-status-pend">Pendientes {counters.pendientes}</span> ·
                <span className="badge alert-status-prog">En progreso {counters.progreso}</span> ·
                <span className="badge alert-status-comp">Completadas {counters.completadas}</span>
            </p>
            ...
            <div className="filters filters-categories">
                ...
                <div className="field">
                    <label>&nbsp;</label>
                    <button className="btn-secondary" onClick={() => { setFPlant(''); setFSensor(''); setFLevel(''); setFStatus(''); setFFrom(''); setFTo(''); setRows([]); setPage(1); }}>Limpiar</button>
                </div>
            </div>
